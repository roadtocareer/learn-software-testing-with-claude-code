...
<pre style={{color: '#00ff88', margin: 0, fontFamily: "'Courier New', monospace", fontSize: '0.9rem'}}>
...
.claude.json  (project root)       ← Project-level MCP server config & overrides`}
            ...
            {/* Cards: each folder */}
            <h4 style={{color: '#00d4ff'}} className="mt-5 mb-4"><i className="fas fa-layer-group"></i> What Each Part Does</h4>
            <div className="row">
              ...
              <div className="col-lg-6 mb-4">
                <div className="card h-100" style={{borderColor: '#00d4ff'}}>
                  <div className="card-body">
                    <div className="icon-box" style={{background: 'linear-gradient(135deg, #00d4ff, #0077aa)'}}><i className="fas fa-memory"></i></div>
                    <h5 className="card-title text-center" style={{color: '#00d4ff'}}>memory/</h5>
                    <p className="text-center" style={{color: '#a0a0b0', fontSize: '0.85rem'}}>Persistent knowledge that survives across conversations</p>
                    <hr style={{borderColor: '#00d4ff33'}} />
                    ...
                    <div className="code-block" style={{fontSize: '0.82rem', borderColor: '#00d4ff', marginTop: '10px'}}>
                      <strong style={{color: '#00d4ff'}}>Types:</strong> user · feedback · project · reference
                    </div>
                    <p style={{fontSize: '0.82rem', marginTop: '10px', color: '#a0a0b0'}}><i className="fas fa-circle-info" style={{color: '#00d4ff'}}></i> Example: <em>"User prefers integration tests over mocks — burned by a failed prod migration."</em></p>
                  </div>
                </div>
              </div>
              ...
              <div className="col-lg-6 mb-4">
                <div className="card h-100" style={{borderColor: '#7b2ff7'}}>
                  <div className="card-body">
                    ...
                    <p className="text-center" style={{color: '#a0a0b0', fontSize: '0.85rem'}}>Reusable instruction modules invoked as slash commands</p>
                    ...
                    <p style={{fontSize: '0.82rem', marginTop: '10px', color: '#a0a0b0'}}><i className="fas fa-circle-info" style={{color: '#a855f7'}}></i> Skills are <em>rigid</em> (TDD, debugging) or <em>flexible</em> (pattern-based) — the file itself declares which.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="col-lg-6 mb-4">
                <div className="card h-100" style={{borderColor: '#00ff88'}}>
                  <div className="card-body">
                    <div className="icon-box" style={{background: 'linear-gradient(135deg, #00ff88, #00a855)'}}><i className="fas fa-robot"></i></div>
                    <h5 className="card-title text-center" style={{color: '#00ff88'}}>agents/</h5>
                    <p className="text-center" style={{color: '#a0a0b0', fontSize: '0.85rem'}}>Specialized sub-agents with defined roles, tools, and delegation rules</p>
                    <hr style={{borderColor: '#00ff8833'}} />
                    ...
                    <div className="code-block" style={{fontSize: '0.82rem', borderColor: '#00ff88', marginTop: '10px'}}>
                      <strong style={{color: '#00ff88'}}>qa-agent</strong> — requirements, bugs, test design<br />
                      <strong style={{color: '#00ff88'}}>sdet-agent</strong> — code flow, root cause, security
                    </div>
                    <p style={{fontSize: '0.82rem', marginTop: '10px', color: '#a0a0b0'}}><i className="fas fa-circle-info" style={{color: '#00ff88'}}></i> Agents can spawn other agents in parallel or sequentially for complex pipelines.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="col-lg-6 mb-4">
                <div className="card h-100" style={{borderColor: '#ff9500'}}>
                  <div className="card-body">
                    ...
                    <p className="text-center" style={{color: '#a0a0b0', fontSize: '0.85rem'}}>Custom slash commands that surface agents and skills from the chat bar</p>
                    ...
                    <p style={{fontSize: '0.82rem', marginTop: '10px', color: '#a0a0b0'}}><i className="fas fa-circle-info" style={{color: '#ff9500'}}></i> Commands are the user-facing entry point — skills and agents are the backend logic.</p>
                  </div>
                </div>
              </div>
                  ...
                  <div className="card-body">
                    <div className="row align-items-center">
                      ...
                      <div className="col-md-10">
                        <h5 style={{color: '#ffd700'}}>~/.claude.json &nbsp;<span style={{fontSize: '0.75rem', color: '#a0a0b0', fontWeight: 'normal'}}>(project root)</span></h5>
            ...
            <h4 style={{color: '#00d4ff'}} className="mt-4 mb-3"><i className="fas fa-diagram-project"></i> How It All Flows Together</h4>
            <p style={{color: '#a0a0b0'}}>When you type a prompt or a slash command, Claude orchestrates all these layers in sequence:</p>

            <div className="highlight-box mt-3 mb-4">
              <div className="row text-center">
                <div className="col" style={{borderRight: '1px solid #00d4ff33'}}>
                  <p style={{color: '#00d4ff', fontWeight: 'bold', fontSize: '0.9rem'}}><i className="fas fa-keyboard"></i><br />User Prompt</p>
                  <p style={{fontSize: '0.8rem', color: '#a0a0b0'}}>You type a message or <code>/command</code></p>
                </div>
                <div className="col" style={{borderRight: '1px solid #00d4ff33'}}>
                  <p style={{color: '#a855f7', fontWeight: 'bold', fontSize: '0.9rem'}}><i className="fas fa-memory"></i><br />Load Memory</p>
                  <p style={{fontSize: '0.8rem', color: '#a0a0b0'}}><code>MEMORY.md</code> index injected into context</p>
                </div>
                <div className="col" style={{borderRight: '1px solid #00d4ff33'}}>
                  <p style={{color: '#ff9500', fontWeight: 'bold', fontSize: '0.9rem'}}><i className="fas fa-terminal"></i><br />Select Command</p>
                  <p style={{fontSize: '0.8rem', color: '#a0a0b0'}}>Slash command expands from <code>commands/</code></p>
                </div>
                <div className="col" style={{borderRight: '1px solid #00d4ff33'}}>
                  <p style={{color: '#00ff88', fontWeight: 'bold', fontSize: '0.9rem'}}><i className="fas fa-robot"></i><br />Invoke Agent</p>
                  <p style={{fontSize: '0.8rem', color: '#a0a0b0'}}>Agent definition loaded from <code>agents/</code></p>
                </div>
                <div className="col">
                  <p style={{color: '#ffd700', fontWeight: 'bold', fontSize: '0.9rem'}}><i className="fas fa-wand-magic-sparkles"></i><br />Execute Skills</p>
                  <p style={{fontSize: '0.8rem', color: '#a0a0b0'}}>Agent applies skill logic from <code>skills/</code></p>
                </div>
              </div>
            </div>

            {/* Mermaid Diagram */}
            <h4 style={{color: '#00d4ff'}} className="mt-5 mb-3"><i className="fas fa-sitemap"></i> Agent Decision Flow</h4>
            <p style={{color: '#a0a0b0'}}>This diagram shows the full decision engine — from user prompt through agent selection, skill execution, and whether external data (MCP) is needed before returning a response.</p>
            ...
            <div className="text-center mt-4">
              <img
                ...
                style={{maxWidth: '480px', width: '100%', border: '2px solid #00d4ff44', borderRadius: '12px', background: '#fff', padding: '16px'}}
              />
              <p style={{fontSize: '0.8rem', color: '#a0a0b0', marginTop: '12px'}}>
                <i className="fas fa-circle-info" style={{color: '#00d4ff'}}></i>
            ...
            {/* Quick Reference */}
            <h4 style={{color: '#00d4ff'}} className="mt-5 mb-3"><i className="fas fa-table"></i> Quick Reference</h4>
            <div className="table-responsive">
              <table className="table" style={{color: '#e0e0e0', borderColor: '#2a2a4a'}}>
                <thead>
                  <tr style={{borderColor: '#2a2a4a', background: '#12122a'}}>
                    <th style={{color: '#00d4ff', borderColor: '#2a2a4a'}}>Path</th>
                    <th style={{color: '#00d4ff', borderColor: '#2a2a4a'}}>Scope</th>
                    <th style={{color: '#00d4ff', borderColor: '#2a2a4a'}}>What lives here</th>
                    <th style={{color: '#00d4ff', borderColor: '#2a2a4a'}}>When it loads</th>
                  </tr>
                </thead>
                <tbody>
                  <tr style={{borderColor: '#2a2a4a'}}>
                    <td><code style={{color: '#00d4ff'}}>~/.claude/memory/</code></td>
                    <td><span style={{color: '#a0a0b0'}}>Global</span></td>
                  ...
                  <tr style={{borderColor: '#2a2a4a'}}>
                    <td><code style={{color: '#00ff88'}}>~/.claude/agents/</code></td>
                    <td><span style={{color: '#a0a0b0'}}>Global</span></td>
                  ...
                  <tr style={{borderColor: '#2a2a4a'}}>
                    ...
                    <td><span style={{color: '#a0a0b0'}}>Project</span></td>
